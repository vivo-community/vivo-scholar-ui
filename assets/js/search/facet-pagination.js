...
// FIXME: should be able to merge with 'pagination.js'
// mostly the same
class FacetPagination extends LitElement {
  ...
  handlePageSelected(e) {
    ...
    this.dispatchEvent(new CustomEvent('facetPageSelected', {
      detail: { value: page },
      bubbles: true,
      cancelable: false,
      composed: true
...
customElements.define('vivo-facet-pagination', FacetPagination);
